...
export default function Form({
    ...
    return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-10 md:p-24">
      ...
      <form className="container flex md:flex-row flex-col justify-center" action={search}>
        <span className="w-full md:w-4/12 lg:w-64 h-fit md:border-r group">
          <input type="text" className="py-2 px-4 m-0 w-full h-full sm:rounded-xl md:rounded-l-xl md:rounded-r-none shadow-lg outline-none focus:bg-green-100 focus:font-semibold" placeholder="Usario" name="user" defaultValue={user ?? ""}/>
          <small className="italic text-slate-500 group-hover:text-slate-900 text-center block w-full mt-1">Usuario de github</small>
        </span>
        <span className="w-full md:w-4/12 lg:w-64 h-fit md:border-r group">
          <input type="text" className="sm:rounded-xl md:rounded-none py-2 px-4 m-0 w-full h-full shadow-lg outline-none focus:bg-green-100 focus:font-semibold" placeholder="Dependencia" name="dependencie" defaultValue={dependencie ?? ""}/>
